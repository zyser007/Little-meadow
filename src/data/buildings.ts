...
export type BuildingAction = "sleep" | "shop" | "none";
...
export const BUILDINGS: Record<string, BuildingDef> = {
  ...
  coop: { id: "coop", name: "Coop", action: "none", wall: "#e8d2a8", roof: "#b9844a" },
  barn: { id: "barn", name: "Barn", action: "none", wall: "#d98b5a", roof: "#8a4a2e" },
